...
<html>
	...
	<body>
			            ...
			            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
			            	<div class="row menu">
			                	<ul class="nav navbar-nav col-lg-9 col-md-9 col-sm-9 col-xs-12">
						            <li class="col-lg-1 col-md-1 col-sm-2 col-xs-12 col-lg-offset-4 col-md-offset-4 col-sm-offset-1 text-center"><a href="<?= base_url(); ?>home">HOME</a></li>
		...
		<div class="section col-lg-9 col-md-9 visible-lg visible-md">
			...
			<div class="col-lg-12 col-md-12" style="padding:0">
				<h3>الوحدات</h3>
				<div class="sets col-lg-12 col-md-12 row">
					<div class="image col-lg-3 col-md-3">
						...
						<div class="price">
							...
							<button type="button" onclick="">التفاصيل</button>
						</div>
					</div>
					<div class="image col-lg-3 col-md-3">
